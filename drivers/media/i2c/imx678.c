...
static const struct cci_reg_sequence imx675_common_regs[] = {
	...
	//{ CCI_REG8(0x301A), 0x08 }, // HDR mode select (Normal) under debugging, set CHDR mode
	{ CCI_REG8(0x301B), 0x00 }, // Normal/binning
	{ CCI_REG8(0x301C), 0x00 }, // XVS sub sample
	{ CCI_REG8(0x301E), 0x01 }, // virtual channel
	{ CCI_REG8(0x303C), 0x00 }, // PIX HSTART
	{ CCI_REG8(0x303D), 0x00 }, // PIX HSTART
	{ CCI_REG8(0x303E), 0x30 }, // H WIDTH
	{ CCI_REG8(0x303F), 0x0A }, // H WIDTH
	{ CCI_REG8(0x3044), 0x00 }, // PIX VSTART
	{ CCI_REG8(0x3045), 0x00 }, // PIX VSTART
	{ CCI_REG8(0x3046), 0xAC }, // V WIDTH
	{ CCI_REG8(0x3047), 0x07 }, // V WIDTH

	{ CCI_REG8(0x3060), 0x95 }, //    # RHS1[19:0]
	{ CCI_REG8(0x3061), 0x00 },
	{ CCI_REG8(0x3062), 0x00 },
	{ CCI_REG8(0x3064), 0x56 }, //    # RHS2[19:0]
