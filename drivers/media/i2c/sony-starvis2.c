 ...
 *         pixels.
 * IMX585: Diagonal 12.84 mm (Type 1/1.2) CMOS image sensor with 8.40 M effective
 *         pixels.
 *
...
static const struct cci_reg_sequence imx675_common_regs[] = {
	...
	{ STARVIS2_REG_XXS_OUTSEL, 0xaa },
	{ STARVIS2_REG_XXS_DRV, 0x0f },
	...
	{ CCI_REG8(0x3c0a), 0x1f },
	{ CCI_REG8(0x3c0b), 0x1f },
	{ CCI_REG8(0x3c0c), 0x1f },
	{ CCI_REG8(0x3c0d), 0x1f },
	{ CCI_REG8(0x3c0e), 0x1f },
	{ CCI_REG8(0x3c0f), 0x1f },
	{ CCI_REG8(0x3c30), 0x73 },
	{ CCI_REG8(0x3c3c), 0x20 },
	{ CCI_REG8(0x3c44), 0x06 },
	...
	{ CCI_REG8(0x4550), 0x10 },
	{ CCI_REG8(0x4551), 0x10 },
	{ CCI_REG8(0x4552), 0x10 },
	{ CCI_REG8(0x4553), 0x10 },
	{ CCI_REG8(0x4554), 0x10 },
	{ CCI_REG8(0x4555), 0x10 },
	{ CCI_REG8(0x4556), 0x10 },
	{ CCI_REG8(0x4557), 0x10 },
	{ CCI_REG8(0x4558), 0x10 },
	{ CCI_REG8(0x455c), 0x10 },
	{ CCI_REG8(0x455d), 0x10 },
	{ CCI_REG8(0x455e), 0x10 },
	{ CCI_REG8(0x455f), 0x10 },
	{ CCI_REG8(0x4560), 0x10 },
	{ CCI_REG8(0x4561), 0x10 },
	{ CCI_REG8(0x4562), 0x10 },
	{ CCI_REG8(0x4563), 0x10 },
	{ CCI_REG8(0x4564), 0x10 },
...
static const u16 imx675_min_hmax_2lane[] = {
	[STARVIS2_LINK_FREQ_297MHZ] = 2044,
	[STARVIS2_LINK_FREQ_360MHZ] = 1692,
	[STARVIS2_LINK_FREQ_445MHZ] = 1376,
	[STARVIS2_LINK_FREQ_594MHZ] = 1064,
	[STARVIS2_LINK_FREQ_720MHZ] = 840,
	[STARVIS2_LINK_FREQ_891MHZ] = 684,
	[STARVIS2_LINK_FREQ_1039MHZ] = 592,
	[STARVIS2_LINK_FREQ_1188MHZ] = 528,
};

const struct starvis2_variant imx675_variant_def = {
	.name = "imx675",
	.id_reg = STARVIS2_REG_MODULE_ID,
	.id_value = 0x296,
	.native_area = {
	...
	.vmax_default = 2024,
	.hmax_min_link_freq = imx675_min_hmax_2lane,
...
static const u16 imx585_min_hmax_2lane[] = {
	[STARVIS2_LINK_FREQ_297MHZ] = 1980,
	[STARVIS2_LINK_FREQ_360MHZ] = 1980,
	[STARVIS2_LINK_FREQ_445MHZ] = 1188,
	[STARVIS2_LINK_FREQ_594MHZ] = 990,
...
const struct starvis2_variant imx585_variant_def = {
	.name = "imx585",
	.id_reg = STARVIS2_REG_MODULE_ID,
	.id_value = 0x296,
	.active_area = {
	...
	.pixel_rate = 594000000,
	.pix_per_clk = 8,
	.common_regs = imx585_common_regs,
	.num_common_regs = ARRAY_SIZE(imx585_common_regs),
	.vmax_default = 2250,
	.hmax_min_link_freq = imx585_min_hmax_2lane,
	.hmax_min_pixel_array = 550,
};
...
struct starvis2_model_info {
	...
	const struct starvis2_variant *variant;

	const struct starvis2_model_info *auto_detect_colour;
	const struct starvis2_model_info *auto_detect_mono;
};
...
static const struct starvis2_model_info imx678_autodetect_info = {
	.variant = &imx678_variant_def,
...
static const struct starvis2_model_info imx675_aaqr_info = {
	.type = STARVIS2_COLOR,
	.codes = codes_bayer,
	.num_codes = ARRAY_SIZE(codes_bayer),
...
static const struct starvis2_model_info imx675_aamr_info = {
	.type = STARVIS2_MONOCHROME,
	.codes = codes_monochrome,
	.num_codes = ARRAY_SIZE(codes_monochrome),
	.variant = &imx675_variant_def,
...
static const struct starvis2_model_info imx675_autodetect_info = {
	.variant = &imx675_variant_def,
...
static const struct starvis2_model_info imx585_aaqr_info = {
	.type = STARVIS2_COLOR,
	.codes = codes_bayer,
	.num_codes = ARRAY_SIZE(codes_bayer),
	.variant = &imx585_variant_def,
};

static const struct starvis2_model_info imx585_aamr_info = {
	.type = STARVIS2_MONOCHROME,
	.codes = codes_monochrome,
	.num_codes = ARRAY_SIZE(codes_monochrome),
	.variant = &imx585_variant_def,
...
static const struct starvis2_model_info imx585_autodetect_info = {
	.variant = &imx585_variant_def,
	.auto_detect_colour = &imx585_aaqr_info,
	.auto_detect_mono = &imx585_aamr_info,
};
...
static int starvis2_set_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	if (ctrl->id == V4L2_CID_LINK_FREQ) {
		...
		if (starvis2->lane_mode == STARVIS2_LANEMODE_4L)
			hmax = max(hmax >> 1, variant->hmax_min_pixel_array);
				  ...
				  struct v4l2_subdev_selection *sel)
{
	...
	case V4L2_SEL_TGT_NATIVE_SIZE:
		sel->r = starvis2->variant->native_area;
		return 0;

	case V4L2_SEL_TGT_CROP_DEFAULT:
	case V4L2_SEL_TGT_CROP_BOUNDS:
		sel->r = starvis2->variant->active_area;
		return 0;
	}
			       ...
			       struct v4l2_subdev_state *state)
{
	...
	*crop = starvis2->variant->active_area;

	format = v4l2_subdev_state_get_format(state, STARVIS2_SOURCE_PAD);
	format->code = starvis2_default_mbus_code(starvis2);
	format->width = starvis2->variant->active_area.width;
	format->height = starvis2->variant->active_area.height;
...
static int starvis2_write_common(struct starvis2 *starvis2)
{
	...
	if (!starvis2->variant)
		/* Powered on during probe to do detection. Variant unknown. */
		return 0;

	cci_multi_reg_write(starvis2->cci, starvis2->variant->common_regs,
			    starvis2->variant->num_common_regs, &ret);
				   ...
				   const struct v4l2_rect *crop)
{
	...
	cci_write(starvis2->cci, STARVIS2_REG_PIX_VST,
		  crop->top - starvis2->variant->active_area.top, &ret);
...
static int starvis2_init_controls(struct starvis2 *starvis2)
{
	...
	hblank = hmax * starvis2->variant->pix_per_clk -
					starvis2->variant->active_area.width;
	max_hblank = STARVIS2_HMAX_MAX * starvis2->variant->pix_per_clk -
		     starvis2->variant->active_area.width;
...
static int starvis2_probe(struct i2c_client *client)
{
	...
	v4l2_i2c_subdev_set_name(&starvis2->sd, client, starvis2->variant->name,
				 NULL);
...
static const struct of_device_id starvis2_of_match[] = {
	...
	{ .compatible = "sony,imx585-aamr", .data = &imx585_aamr_info },
	{ .compatible = "sony,imx585-aaqr", .data = &imx585_aaqr_info },
	...
	{ .compatible = "sony,imx585", .data = &imx585_autodetect_info },
	{ /* sentinel */ }
};
