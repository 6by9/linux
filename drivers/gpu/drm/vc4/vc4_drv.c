...
static int vc4_drm_bind(struct device *dev)
{
	...
	gen = of_device_get_match_data(dev);
...
static const struct of_device_id vc4_of_match[] = {
	{ .compatible = "brcm,bcm2711-vc5", .data = VC4_GEN_5 },
	{ .compatible = "brcm,bcm2835-vc4", .data = VC4_GEN_4 },
	{ .compatible = "brcm,cygnus-vc4", .data = VC4_GEN_4 },
	{},
};
